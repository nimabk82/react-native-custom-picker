...
var CustomPicker = /** @class */ (function (_super) {
    ...
    CustomPicker.prototype.render = function () {
        var _this = this;
        var _a = this.props, modalAnimationType = _a.modalAnimationType, fieldTemplate = _a.fieldTemplate, optionTemplate = _a.optionTemplate, placeholder = _a.placeholder, options = _a.options, headerTemplate = _a.headerTemplate, footerTemplate = _a.footerTemplate, style = _a.style, fieldTemplateProps = _a.fieldTemplateProps, optionTemplateProps = _a.optionTemplateProps, backdropStyle = _a.backdropStyle, modalStyle = _a.modalStyle;
        var actions = {
        ...
        return (React.createElement(react_native_1.View, null,
            React.createElement(react_native_1.View, { onPress: this.showOptions },
